...
//            {
//                String script = vertex.realWord;
//                int longestSuffixLength = PlaceSuffixDictionary.dictionary.getLongestSuffixLength(script);
//                int wordLength = script.length() - longestSuffixLength;
