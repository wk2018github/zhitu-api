...
public abstract class Corpus
{
    ...
    /**
     * @return -4 if is dropped, -3 if end of sentence, -2 if end of corpus, -1 if word not found or index script of the word
     * @throws IOException
     */
    public int readWordIndex() throws IOException
    {
        ...
        {
            return searchVocab(word);     // index script of the word
        }
    }
