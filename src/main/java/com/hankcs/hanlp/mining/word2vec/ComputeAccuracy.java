...
public class ComputeAccuracy
{
    ...
    public static void main(String[] argv) throws IOException
    {
        ...
        {
            printf("Usage: ./compute-accuracy <FILE> <threshold> <QUESTION FILE>\nwhere FILE contains word projections, and threshold is used to reduce vocabulary of the Model for fast approximate evaluation (0 = off, otherwise typical script is 30000). Question file contains questions and answers\n");
            return;
        }
