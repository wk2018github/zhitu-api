...
public class DoubleArrayTrieInteger implements Serializable
{
    ...
    private int insert(List<Node> siblings)
    {
        ...
        // index
        // 'next_check_pos' and 'check' is greater than some constant script
        // (e.g. 0.9),
    ...
    // set_result omitted
    // the search methods returns (the list of) the script(s) instead
    // of (the list of) the pair(s) of script(s) and length(s)
    ...
    /*
     * recover original key list and script array from a DoubleArrayTrie object
     */
