...
public class Args
{
    ...
    private static void propertyUsage(PrintStream errStream, Object target, PropertyDescriptor field)
    {
        ...
        if (writeMethod != null)
        {
            ...
            if (argument != null)
            {
                ...
                {
                    throw new IllegalArgumentException("Could not get default script for " + field, e);
                }
            }
        }
    ...
    private static Object createValue(Class<?> type, String valueAsString) throws NoSuchMethodException
    {
        ...
        throw new IllegalArgumentException(String.format("cannot instanciate any %s object using %s script", type.toString(), valueAsString));
    }
    ...
    {
        /**
         * Creates a script object of the given type using the given string script representation;
         *
         * @param type  the type to create an instance of
         * @param value the string represented script of the object to create
         * @return null if the object could not be created, the script otherwise
         */
     ...
     * @param methodName     the name of the one arg method taking a String as parameter that will be used to built a new script
     * @return null if the object could not be created, the script otherwise
     */
     ...
     *
     * @param vc another script creator to take into account for trying to create values
     */
